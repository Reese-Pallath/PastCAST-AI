...
import { WeatherAPIHandler, GlobalWeatherData } from '../lib/weatherAPIHandler';
    ...
    navigator.geolocation.getCurrentPosition(
      async (position) => {
        ...
        try {
          ...
          const weather = await WeatherAPIHandler.getWeatherByCoordinates(latitude, longitude);
          setWeatherData(weather);
    ...
    <div className="relative">
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 shadow-2xl hover:shadow-blue-500/10 transition-all duration-300">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 text-center border border-white/10 shadow-lg hover:shadow-blue-500/10 transition-all duration-300 transform hover:scale-105">
                ...
                <div className="text-white/70 text-sm mb-2 font-medium">Wind Speed</div>
                <div className="text-white font-bold text-2xl">
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 text-center border border-white/10 shadow-lg hover:shadow-blue-500/10 transition-all duration-300 transform hover:scale-105">
                ...
                <div className="text-white/70 text-sm mb-2 font-medium">Coordinates</div>
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 shadow-2xl hover:shadow-blue-500/10 transition-all duration-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
                {weatherData.forecast.map((day, index) => (
                  <div key={index} className="bg-white/5 backdrop-blur-sm rounded-xl p-6 text-center border border-white/10 shadow-lg hover:shadow-blue-500/10 transition-all duration-300 transform hover:scale-105 animate-in fade-in-50" style={{ animationDelay: `${index * 100}ms` }}>
      ...
      {!weatherData && (
        <div className="text-center py-12">
          ...
          <h3 className="text-white text-xl font-semibold mb-2">Search Global Weather</h3>
          <p className="text-white/70 text-lg mb-2">Search for any city worldwide to get current weather data</p>
          <p className="text-white/60 text-sm">Supports cities from all countries and continents</p>
        </div>
      )}
      </div>
    </div>
